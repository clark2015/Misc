...
namespace lua_tinker
{
    ...
    public:
        ...
        check_stack(lua_State* L)
            : _L(L)
        {
            _stack = lua_gettop(_L);
        }
        ~check_stack()
        {
            assert(_stack == lua_gettop(_L));
        }
    private:
        lua_State* _L;
        int _stack;
...
template<typename A, typename B>		struct if_<false, A, B> { typedef B type; };
	...
	{
		static int invoke(lua_State *L) { push(L,(read<T*>(L,1)->*upvalue_<void(T::*)(T1,T2,T3,T4,T5,T6,T7,T8)>(L))(read<T1>(L,2),read<T2>(L,3),read<T3>(L,4),read<T4>(L,5),read<T5>(L,6),read<T6>(L,7),read<T7>(L,8),read<T8>(L,9)));; return 0; }
	};
    
    template<typename T, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7>
	struct mem_functor<void,T,T1,T2,T3,T4,T5,T6,T7>
	{
		static int invoke(lua_State *L) { push(L,(read<T*>(L,1)->*upvalue_<void(T::*)(T1,T2,T3,T4,T5,T6,T7)>(L))(read<T1>(L,2),read<T2>(L,3),read<T3>(L,4),read<T4>(L,5),read<T5>(L,6),read<T6>(L,7),read<T7>(L,8)));; return 0; }
	};
    
    template<typename T, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>
	struct mem_functor<void,T,T1,T2,T3,T4,T5,T6>
	{
		static int invoke(lua_State *L) { push(L,(read<T*>(L,1)->*upvalue_<void(T::*)(T1,T2,T3,T4,T5,T6)>(L))(read<T1>(L,2),read<T2>(L,3),read<T3>(L,4),read<T4>(L,5),read<T5>(L,6),read<T6>(L,7)));; return 0; }
	};
	...
	RVal call(lua_State* L, const char* name)
	{
		...
		if(lua_isfunction(L,-1))
		{
			...
			{
                // remove the error functor, and the error code
				lua_pop(L, 2);
                return RVal();
			}
		}
		else
		{
            ...
            // remove "lua_function", the error functor
		    lua_pop(L, 2);
            return RVal();
		}
	...
	// call
	template<typename RVal>
	RVal call_deep(int deep, lua_State* L, const char* name)
	{
        check_stack check(L);
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
		...
		if(lua_isfunction(L,-1))
		{
			if(lua_pcall(L, 0, 1, errfunc) != 0)
			{
                ...
                if(deep <= 0)
                    ...
                    return call_deep<RVal>(L, name, --deep);
			}
		}
		else
		{
	...
	template<typename RVal, typename T1>
	RVal call_deep(int deep, lua_State* L, const char* name, T1 arg1)
	{
        check_stack check(L);
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
		...
		if(lua_isfunction(L,-1))
		{
			...
			if(lua_pcall(L, 1, 1, errfunc) != 0)
			{
                ...
                if(deep <= 0)
                    ...
                    return call_deep<RVal>(--deep, L, name, arg1);
			}
		}
		else
		{
	...
	template<typename RVal, typename T1, typename T2>
	RVal call_deep(int deep, lua_State* L, const char* name, T1 arg1, T2 arg2)
	{
        check_stack check(L);
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
		...
		if(lua_isfunction(L,-1))
		{
			...
			if(lua_pcall(L, 2, 1, errfunc) != 0)
			{
                ...
                if(deep <= 0)
                    ...
                    return call_deep<RVal>(--deep, L, name, arg1, arg2);
			}
		}
		else
		{
	...
	template<typename RVal, typename T1, typename T2, typename T3>
	RVal call_deep(int deep, lua_State* L, const char* name, T1 arg1, T2 arg2, T3 arg3)
	{
        check_stack check(L);
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
		...
		if(lua_isfunction(L,-1))
		{
			...
			if(lua_pcall(L, 3, 1, errfunc) != 0)
			{
                ...
                if(deep <= 0)
                    ...
                    return call_deep<RVal>(--deep, L, name, arg1, arg2, arg3);
			}
		}
		else
		{
	...
	template<typename RVal, typename T1, typename T2, typename T3, typename T4>
	RVal call_deep(int deep, lua_State* L, const char* name, T1 arg1, T2 arg2, T3 arg3, T4 arg4)
	{
        check_stack check(L);
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
		...
		if(lua_isfunction(L,-1))
		{
			...
			if(lua_pcall(L, 4, 1, errfunc) != 0)
			{
                ...
                if(deep <= 0)
                    ...
                    return call_deep<RVal>(--deep, L, name, arg1, arg2, arg3, arg4);
			}
		}
		else
		{
	...
	template<typename RVal, typename T1, typename T2, typename T3, typename T4, typename T5>
	RVal call_deep(int deep, lua_State* L, const char* name, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5)
	{
        check_stack check(L);
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
		...
		if(lua_isfunction(L,-1))
		{
			...
			if(lua_pcall(L, 5, 1, errfunc) != 0)
			{
                ...
                if(deep <= 0)
                    ...
                    return call_deep<RVal>(--deep, L, name, arg1, arg2, arg3, arg4, arg5);
			}
		}
		else
		{
	...
	template<typename RVal>
	RVal membercall(lua_State* L, const char* tn, int n)
	{
        check_stack check(L);
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
		...
		if(lua_isfunction(L,-1))
		{
			if(lua_pcall(L, 0, 1, errfunc) != 0)
			{
                // remove the table, the error functor, and the error code
				lua_pop(L, 3);
                return RVal();
			}
		}
		...
		{
			print_error(L, "lua_tinker::membercall() attempt to call global `%s' `%d' (not a function)", tn, n);
            // remove "lua_function", the table, the error functor
		    lua_pop(L, 3);
            return RVal();
		}
	...
	template<typename RVal, typename T1>
	RVal membercall(lua_State* L, const char* tn, int n, T1 arg)
	{
        check_stack check(L);
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
	...
	template<typename RVal, typename T1, typename T2>
	RVal membercall(lua_State* L, const char* tn, int n, T1 arg1, T2 arg2)
	{
        check_stack check(L);
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
	...
	template<typename RVal, typename T1, typename T2, typename T3>
	RVal membercall(lua_State* L, const char* tn, int n, T1 arg1, T2 arg2, T3 arg3)
	{
        check_stack check(L);
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
	...
	template<typename RVal, typename T1, typename T2, typename T3, typename T4, typename T5>
	RVal membercall(lua_State* L, const char* tn, const char* fn, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5)
	{
        check_stack check(L);
		lua_pushcclosure(L, on_error, 0);
		int errfunc = lua_gettop(L);
...
#ifdef _WINDOWS
			if(name) strncpy_s(temp, name, sizeof(temp));
#else
			if(name) strncpy(temp, name, sizeof(temp));
#endif
			return temp;
		}
	};
	...
	struct table_obj
	{
		...
		template<typename T>
		void set(int n, T object)
		{
			if(validate())
			{
				lua_pushnumber(m_L, n);
				push(m_L, object);
				lua_settable(m_L, m_index);
			}
		}
	...
	struct table
	{
		...
		template<typename T>
		void set(int number, T object)
		{
			m_obj->set(number, object);
		}
